var FindProxyForURL = function(init, profiles) {
    ...
    "+\u81ea\u52a8\u5207\u6362": function(url, host, scheme) {
        "use strict";
        if (/(?:^|\.)gfycat\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)pixiv\.net$/.test(host)) return "+ss";
        if (/(?:^|\.)myvidster\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)digitalero\.rip$/.test(host)) return "+ss";
        if (/(?:^|\.)sfmlab\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)studiofow\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)javhd\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)r34anim\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)paheal\.net$/.test(host)) return "+ss";
        if (/(?:^|\.)maxfile\.ro$/.test(host)) return "+ss";
        if (/(?:^|\.)tumbex\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)giphy\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)xhamster\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)onion\.rip$/.test(host)) return "+ss";
        if (/(?:^|\.)digitalocean\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)rule34\.xxx$/.test(host)) return "+ss";
        if (/(?:^|\.)gamcore\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)donmai\.us$/.test(host)) return "+ss";
        if (/(?:^|\.)gotporn\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)gamesofdesire\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)2adultflashgames\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)hentaibedta\.net$/.test(host)) return "+ss";
        if (/(?:^|\.)funny-games\.biz$/.test(host)) return "+ss";
        if (/(?:^|\.)sankakucomplex\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)pomf\.se$/.test(host)) return "+ss";
        if (/(?:^|\.)rule34hentai\.net$/.test(host)) return "+ss";
        if (/(?:^|\.)pornhub\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)icnmn\.org$/.test(host)) return "+ss";
        if (/(?:^|\.)refractiveindex\.info$/.test(host)) return "+ss";
        if (/(?:^|\.)gutenberg\.us$/.test(host)) return "+ss";
        if (/(?:^|\.)keylol\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)jianshu\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)grammarly\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)pomf\.cat$/.test(host)) return "+ss";
        if (/(?:^|\.)webmup\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)mixtape\.moe$/.test(host)) return "+ss";
        if (/^174\.16\.40\.246$/.test(host)) return "+ss";
        if (/(?:^|\.)e-hentai\.org$/.test(host)) return "+ss";
        if (/(?:^|\.)gamemastertips\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)jetbrains\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)realvnc\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)github-cloud\.s3\.amazonaws\.com$/.test(host)) return "+ss";
        ...
        if (/(?:^|\.)gfbzb\.gov\.cn$/.test(host)) return "DIRECT";
        if (/(?:^|\.)scitation\.org$/.test(host)) return "+library";
        if (/(?:^|\.)playstation\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)skycitizen\.net$/.test(host)) return "+ss";
        if (/(?:^|\.)imgur\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)webmshare\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)origin\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)sofifa\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)64clouds\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)humblebundle\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)twitch\./.test(host)) return "+ss";
        if (/(?:^|\.)github\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)amazon\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)v2ex\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)speedtest\.net$/.test(host)) return "+ss";
        if (/^sci-hub\.cc$/.test(host)) return "+ss";
        if (/^feedly\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)nature\.com$/.test(host)) return "+library";
        if (/(?:^|\.)aps\.org$/.test(host)) return "+library";
        if (/(?:^|\.)wiley\.com$/.test(host)) return "+library";
        if (/(?:^|\.)osapublishing\.org$/.test(host)) return "+library";
        if (/^webofknowledge\.com$/.test(host)) return "+library";
    ...
    "+__ruleListOf_\u81ea\u52a8\u5207\u6362": function(url, host, scheme) {
        ...
        if (/(?:^|\.)2dbook\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)4tern\.com$/.test(host)) return "+ss";
        if (/^http:\/\/85\.17\.73\.31\//.test(url)) return "+ss";
        if (/(?:^|\.)adorama\.com$/.test(host)) return "+ss";
        ...
        if (/(?:^|\.)findmima\.com$/.test(host)) return "+ss";
        ...
        if (/^https:\/\/github\.com\/programthink\/zhao/.test(url)) return "+ss";
        ...
        if (/^http:\/\/imgur\.com\/upload/.test(url)) return "+ss";
        if (/^https:\/\/imgur\.com\/upload/.test(url)) return "+ss";
        ...
        if (scheme === "http" && url.indexOf(".google.cat") >= 0) return "+ss";
        ...
        if (/(?:^|\.)googlecapital\.com$/.test(host)) return "+ss";
        ...
        if (scheme === "http" && url.indexOf(".kat.cr") >= 0) return "+ss";
        ...
        if (/^http:\/\/archive\.is/.test(url)) return "+ss";
        ...
        if (/(?:^|\.)arstechnica\.com$/.test(host)) return "+ss";
        ...
        if (scheme === "http" && url.indexOf(".bbc.co.uk/chinese") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".bbc.co.uk/news/world-asia-china") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".bbc.co.uk/tv") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".bbc.co.uk/zhongwen") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".bbc.com/ukchina") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".bbc.com/zhongwen") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".bbc.com%2Fzhongwen") >= 0) return "+ss";
        ...
        if (/^http:\/\/canyu\.org/.test(url)) return "+ss";
        ...
        if (scheme === "http" && url.indexOf(".chinatimes.com/realtimenews/260409/") >= 0) return "+ss";
        ...
        if (scheme === "http" && url.indexOf("download.cnet.com/Freegate") >= 0) return "+ss";
        ...
        if (/^https:\/\/search\.disconnect\.me/.test(url)) return "+ss";
        ...
        if (/^http:\/\/e123\.hk\//.test(url)) return "+ss";
        ...
        if (scheme === "http" && url.indexOf(".enanyang.my/news/20170502/%E7%BE%8E%E5%9B%BD%E4%B9%8B%E9%9F%B3%E5%A4%A7%E5%9C%B0%E9%9C%87%E3%80%8A%E8%8B%B9%E6%9E%9C%E3%80%8B%E7%8B%AC%E5%AE%B6") >= 0) return "+ss";
        ...
        if (scheme === "http" && url.indexOf(".eslite.com/product") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".eslite.com/Search_BW.aspx?q") >= 0) return "+ss";
        ...
        if (/^http:\/\/expressvpn\.com/.test(url)) return "+ss";
        ...
        if (scheme === "http" && url.indexOf(".ftchinese.com/channel/video") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/00102753") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001026807") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001032692") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001037090") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001037091") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001038220") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001040890") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001040918") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001042100") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001042252") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001042272") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001044776") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001045755") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001046118") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001047345") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001047375") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001047545") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001048710") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001049360") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001051372") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001052965") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001053526") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001054103") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001054168") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001054526") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001054644") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001055299") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001055551") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001055559") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001056529") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001056554") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001056567") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001056588") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001056596") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001057509") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001057533") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001058295") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001058344") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001058458") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001058468") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001058561") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001058566") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001058567") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001058585") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001058628") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001058678") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001059484") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001059538") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001059818") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001059914") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001059920") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001060181") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001060493") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001060495") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001060921") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001061120") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001062028") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001062176") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001062482") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001062508") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001062741") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001062794") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001063160") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001063692") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001063826") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001065287") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001066465") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001066959") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001067435") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf("www.ftchinese.com/story/001067479") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001067545") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001067648") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001067650") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001068248") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001068278") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001068379") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001068483") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001069373") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001069516") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001070307") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001070809") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001070990") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001071042") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001071106") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001071181") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001071208") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/story/001071238") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/video/1437") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf(".ftchinese.com/video/1882") >= 0) return "+ss";
        ...
        if (/^http:\/\/gfw\.press/.test(url)) return "+ss";
        ...
        if (scheme === "http" && url.indexOf(".github.com") >= 0) return "+ss";
        ...
        if (scheme === "http" && url.indexOf(".m-team.cc") >= 0) return "+ss";
        ...
        if (/^http:\/\/mobile01\.com/.test(url)) return "+ss";
        ...
        if (/(?:^|\.)nyaa\.eu$/.test(host)) return "+ss";
        ...
        if (/(?:^|\.)a1\.nyt\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)int\.nyt\.com$/.test(host)) return "+ss";
        if (scheme === "http" && url.indexOf("static01.nyt.com") >= 0) return "+ss";
        if (/(?:^|\.)static01\.nyt\.com$/.test(host)) return "+ss";
        if (/(?:^|\.)typeface\.nyt\.com$/.test(host)) return "+ss";
        ...
        if (/^https:\/\/ozvoice\.org/.test(url)) return "+ss";
        ...
        if (/(?:^|\.)pangci\.net$/.test(host)) return "+ss";
        if (/(?:^|\.)panacom\.co\.jp$/.test(host)) return "+ss";
        ...
        if (scheme === "http" && url.indexOf(".pcstore.com.tw/ntdtvapshop") >= 0) return "+ss";
        ...
        if (/(?:^|\.)roc-taiwan\.org$/.test(host)) return "+ss";
        ...
        if (scheme === "http" && url.indexOf("steamcommunity.com/groups/LibetTibet") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf("steamcommunity.com/groups/zhonggong") >= 0) return "+ss";
        if (scheme === "http" && url.indexOf("steamcommunity.com/id/CJT_Jackton") >= 0) return "+ss";
        ...
        if (/(?:^|\.)taiwanembassy\.org$/.test(host)) return "+ss";
        ...
        if (/(?:^|\.)taiwantoday\.tw$/.test(host)) return "+ss";
        ...
        if (/^http:\/\/v2ray\.com/.test(url)) return "+ss";
        ...
        if (/^http:\/\/zh\.wikinews\.org/.test(url)) return "+ss";
        if (/^http:\/\/zh\.wikivoyage\.org/.test(url)) return "+ss";
        if (/^http:\/\/zh\.wiktionary\.org/.test(url)) return "+ss";
        ...
        if (scheme === "http" && url.indexOf("wuu.wikipedia.org") >= 0) return "+ss";
        if (/^https:\/\/wuu\.wikipedia\.org/.test(url)) return "+ss";
        if (scheme === "http" && url.indexOf("zh-yue.wikipedia.org") >= 0) return "+ss";
        if (/^https:\/\/zh-yue\.wikipedia\.org/.test(url)) return "+ss";
        ...
        if (/^http:\/\/zhenlibu1984\.com/.test(url)) return "+ss";
        ...
        if (scheme === "http" && url.indexOf("zhuangbi.me/account/login/url-Lw==") >= 0) return "+ss";
    ...
    "+ss": function(url, host, scheme) {
        "use strict";
        if (/^127\.0\.0\.1$/.test(host) || /^::1$/.test(host) || /^localhost$/.test(host) || /\.fudan\.edu\.cn$/.test(host) || /^10\..*\..*\./.test(host) || /^192\.168\..*\./.test(host) || /\.douyu\./.test(host) || /douyucdn\./.test(host)) return "DIRECT";
        return "PROXY tencentnew.qyz93.com:8123";
    },
    "+library": function(url, host, scheme) {
        "use strict";
        if (/^127\.0\.0\.1$/.test(host) || /^::1$/.test(host) || /^localhost$/.test(host) || /\.fudan\.edu\.cn$/.test(host) || /^10\..*\..*\./.test(host)) return "DIRECT";
        return "PROXY libproxy.fudan.edu.cn:8080";
    }
});